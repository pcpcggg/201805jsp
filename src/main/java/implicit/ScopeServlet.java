...
public class ScopeServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String applicationScope = request.getParameter("applicationScop");
		
		// 				jsp 		/ servlet
		// page			page		/   X
		// request  	request 	/  request
		// session  	session 	/  requset.getSession()
		...
		//forward로 위임 (scopResult.jsp)
		request.getRequestDispatcher("/implicit/scopResult.jsp").forward(request, response);
